...
<div class="content-box">
    <div class="core">
        ...
        <div class="article-box">
            <ul>
                <li>
                    <a href="article?aid=1" class="title red-title">关于这是一条新闻的通知的新闻</a>
                    <div class="article-detail-box">
                        ...
                        <div class="date-indicator">
                            <div class="date-indicator-day red-date-indicator-day">08</div>
                            <div class="date-indicator-month-year red-date-indicator-month-year">2021-12</div>
                        </div>
                    </div>
                </li>
                <li>
